...
Ce depot a ete **allege pour la demo**.

Il contient uniquement :

- une **stack Docker Compose prete a lancer** depuis la racine
- les **configs minimales SigNoz** necessaires au fonctionnement
- un **lab de test avec 3 machines** pour generer traces, logs et metriques
- une **documentation courte** pour l'installation et la presentation

### Structure utile

- lancement local SigNoz : [compose.yaml](/root/Signoz/compose.yaml)
- aide rapide locale : [LOCAL-SETUP.md](/root/Signoz/LOCAL-SETUP.md)
- lab 3 machines : [lab/compose.yaml](/root/Signoz/lab/compose.yaml)
- doc du lab : [docs/signoz-lab.md](/root/Signoz/docs/signoz-lab.md)
- configs conservees : `deploy/common/clickhouse/` et `deploy/docker/otel-collector-config.yaml`
...
- logs
- metriques
- erreurs volontaires pour tester les alertes
...
Puis ouvre SigNoz sur `http://localhost:8080`.

Tu devrais voir remonter rapidement :

- des services `edge-gateway`, `orders-api`, `billing-worker`
...
- installation locale : [LOCAL-SETUP.md](/root/Signoz/LOCAL-SETUP.md)
- lab et schema reseau : [docs/signoz-lab.md](/root/Signoz/docs/signoz-lab.md)

### Note

La suite du `README.md` d'origine SigNoz a ete laissee telle quelle plus bas pour garder un peu de contexte produit, mais le depot local a ete nettoye pour rester centre sur la demo et le test.
